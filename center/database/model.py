...
class User(me.Document):
    ...
    postsTotal = me.IntField(default=0)
    sellTotal = me.IntField(default=0)
    buyTotal = me.IntField(default=0)
    referralTotal = me.IntField(default=0)
    point = me.StringField()
    isReviewer = me.BooleanField(default=False)
...
class Product(me.Document):
    ...
    status = me.IntField(required=True)
    isNew = me.BooleanField(default=False)
    isReturns = me.BooleanField(default=False)
    ...
    photos = me.ListField(me.StringField())
